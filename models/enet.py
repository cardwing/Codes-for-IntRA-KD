...
class ENet_full(nn.Module):
    ...
    def __init__(self, num_classes, partial_bn=False, encoder_relu=False, decoder_relu=True):
        super().__init__()
        ...
        # self.base_model = ENet(num_classes=37)
    ...
    def train(self, mode=True):
        ...
        :return:
        """
        super(ENet_full, self).train(mode)
        if self._enable_pbn:
    ...
    def get_optim_policies(self):
        ...
        for m in self.modules(): # self.base_model.modules()
